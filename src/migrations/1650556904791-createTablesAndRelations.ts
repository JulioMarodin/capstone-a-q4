...
export class createTablesAndRelations1650556904791 implements MigrationInterface {
    name = 'createTablesAndRelations1650556904791'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "authors" ALTER COLUMN "country" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "authors" ALTER COLUMN "birthday" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "authors" ALTER COLUMN "birthday" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "authors" ALTER COLUMN "country" SET NOT NULL`);
