...
export class createTables1650418733047 implements MigrationInterface {
    name = 'createTables1650418733047';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        '(${hashSync(process.env.ADMIN_PASSWORD)}','admin','${new Date(1990, 0, 29).toJSON()}','${process.env.ADMIN_CITY}',true)`);
    }
